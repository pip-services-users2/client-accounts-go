module github.com/pip-services-users2/client-accounts-go
...
require (
	...
	github.com/pip-services3-gox/pip-services3-grpc-gox v1.0.1
	github.com/pip-services3-gox/pip-services3-rpc-gox v1.0.5
